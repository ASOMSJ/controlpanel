import "../../../node_modules/chart.js/dist/Chart.min.js"
    ...
    (function () {
        ...
        const brandColor = (window.getComputedStyle(chartCanvas)).getPropertyValue('--color-brnd') || "#2541b2";
        const chart = new Chart(chartCanvas, {
            type: "line",
            data: {
                labels: ["ديسمبر", "نوفمبر", "سبتمبر", "اغسطس", "يوليو", "يونيو", "مايو", "ابريل", "مارس", "فبراير", "يناير"],
                datasets: [{
                    label: "مبيعات الشهر",
                    data: data,
